...
//        [self payByWeixin];
//    }];
//    UIAlertAction *action3 = [UIAlertAction actionWithTitle:@"苹果支付" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
//        [self payByApple];
//    }];
//    
...
//    
//    NSArray *product = [[NSArray alloc] initWithObjects:@"yc.jjw6",nil];
...
- (void) productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
    ...
    for (SKProduct *pro in product) {
        ...
        if([pro.productIdentifier isEqualToString:@"com.yc.jjw6"]){
            requestProduct = pro;
        }
    }
